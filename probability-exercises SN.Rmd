...
```{r}
#p = 0.6 of cavs winning
# Prob that celtics lose is 0.6
1 - (0.6)^4
# why is it ^4??
```
...
B <- 10000
results <- replicate(B, {
  cavs_wins <- sample(c(1,0), 6, replace = TRUE, prob = c(0.5, 0.5))
  sum(cavs_wins)>=4})
mean(results)
```
